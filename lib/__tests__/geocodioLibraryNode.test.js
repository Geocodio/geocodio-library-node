...
describe("geocoder", () => {
  ...
  it("Can read link status", () => {
    ...
    return geocoder.list.status(11530326).then(response => {
      expect(response.results.id).toEqual(11530326);
    });
  });
  ...
  it("Can download a list", () => {
    ...
    return geocoder.list.download(11530326).then(response => {
      expect(response.results.id).toEqual(11530326);
    });
  });
  ...
  it("Can delete list", () => {
    ...
    return geocoder.list.deleteList(11530326).then(response => {
